...
class HypergraphModel(nn.Module):
    def __init__(self, num_features, num_classes, edge_features_size):
        ...
        self.fc = nn.Linear(32, num_classes)  # 最后一个全连接层，用于分类
    ...
    def forward(self, x, edge_index, edge_weight, edge_features):
        ...
        output = self.edge_conv(node_features, edge_features)  # 将边特征融合到节点特征中
